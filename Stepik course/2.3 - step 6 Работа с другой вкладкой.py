...
try:
    ...
    joinbutton = browser.find_element(By.CSS_SELECTOR, '[type = "submit"').click()
    new_window = browser.window_handles[1] #Находим второе окно. Указана 1, но первое окно это 0
    browser.switch_to.window(new_window) #Переходимо ко второму окну
